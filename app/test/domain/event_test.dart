  ...
  group('JSON round-trip', () {
    final samples = <Event>[
      ...
      TrackedAccountSet(
        ...
        updateCadence: AccountCadence.quarterly,
      ...
      PurchaseAdded(
        ...
        createdAt: _cre,
        purchaseId: 'p5',
        target: const VacationCharge('v1', 'vc1'),
        amountCents: 4200,
      ),
      VacationSet(
        eventId: 'e',
        ...
        vacationId: 'v1',
        name: 'Tofino',
        fund: const VacationFundQuest('q1'),
      ...
      VacationSet(
        ...
        vacationId: 'v2',
        name: 'Cabin',
        fund: const VacationFundEmergency('f1'),
        startDate: DateTime.utc(2026, 8, 1),
        endDate: DateTime.utc(2026, 8, 3),
        categories: const [
          VacationCategory(categoryId: 'vc3', name: 'Gas', limitCents: 5000),
        ],
      ),
      VacationClosed(
        eventId: 'e',
